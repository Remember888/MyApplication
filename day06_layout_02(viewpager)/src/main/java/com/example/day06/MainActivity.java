...
public class MainActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener{
    ...
    private int images[]={R.mipmap.banner01,R.mipmap.banner02,R.mipmap.banner03};
    ...
    private void setRadioGroup(){
        ...
        RadioButton rBtn= (RadioButton) rGroup.findViewById(R.id.radio1);
    ...
    private void setViewPager() {
        ...
        PagerAdapter adapter=new MainActivity.ImageAdapter();
